...
class GameObject extends MUDObject {
    ...
    */
    ...
    getSharedProperty(key, defaultValue) {
        efuns.assertArgs('getSharedProperty', arguments, 'string');
    ...
    setProperty(key, value) {
        efuns.assertArgs('setProperty', arguments, 'string', '^symbol');
        return super.setProperty(key, value);
    }

    setSharedProperty(key, value) {
        efuns.assertArgs('setSharedProperty', arguments, 'string', '^symbol');
    ...
    setWeight(n, units) {
        ...
        if (typeof units === 'undefined')
            ...
            throw new Error('Bad parameter 1 to setWeight; Expected string got {0}'.fs(typeof units));
...
loadPartial(GameObject, 'Verbs/ItemSupportBase');


MUD.export(GameObject);
