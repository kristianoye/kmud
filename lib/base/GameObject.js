...
class GameObject extends MUDObject {
    ...
    /**
     * A synchronous moveObject method REQUIRES an object instance for destination.
     * @param {MUDObject|MUDWrapper} destination
     */
    moveObject(destination) {
        if (typeof destination !== 'object')
            throw `Bad argument 1 to moveObject() requires object parameter but got ${typeof destination}`;
        this.moveObjectAsync(destination);
    }
...
await module.addMixin(GameObject, 'Verbs/ItemSupportBase');
