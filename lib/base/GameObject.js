 ...
 */
const
    Mixins = await requireAsync('VerbMixins'),
    DropSupport = await requireAsync(Mixins.LIB_DROP),
    GetSupport = await requireAsync(Mixins.LIB_GET),
    ListenSupport = await requireAsync(Mixins.LIB_LISTEN),
    LookSupport = await requireAsync(Mixins.LIB_LOOK),
    PutSupport = await requireAsync(Mixins.LIB_PUT);
class GameObject extends MUDObject, DropSupport, GetSupport, ListenSupport, LookSupport, PutSupport {
    create() {
