...
class Verb extends Command {
    /**
        ...
        */
    constructor(ctx) {
        super(ctx.forceCleanUpdate(true)
            .prop({
                _error: '',
                _verbs: [],
                _rules: []
    ...
    addRules(rules) {
        ...
        efuns.assertArgs('setRules', arguments, 'array<string>');
        ruleList.push(...args);
        return this;
    }
     ...
     */
    setError(msg) {
        efuns.assertArgs('setError', arguments, 'string');
    ...
    setVerb(verb) {
        ...
        efuns.assertArgs('setVerb', arguments, 'array<string>');
        verbs.push(...args);
        return this;
    }
